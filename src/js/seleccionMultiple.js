...
export function crearSeleccionMultiple({ selectorCheckbox, selectAll, boton }) {
    ...
    const actualizar = () => {
        ...
        // El total incluye lo elegido en otras páginas o escondido por un filtro, así que hay que
        // decirlo: si no, el botón parece contar de más.
        const etiqueta = boton?.querySelector('[data-conteo]');
